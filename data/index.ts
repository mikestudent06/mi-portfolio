...
export const projects = [
  {
    id: 1,
    title: "Gymo - Application de Sport",
  ...
  {
    id: 2,
    title: "Pitcheur - Application pour les entrepreneurs qui souhaitent pitcher des projets et trouver des projets intéressants.",
...
export const testimonials = [
  {
    ...
    name: "Sarah Lefèvre",
    title: "Fondatrice de CréaDesign Studio",
    img:"/profile1.jpg"
  },
  {
    quote:
...
export const workExperience = [
  ...
  {
    id: 3,
    title: "Projet de Développement d'App Freelance",
    desc: "Dirigé le développement d'une application mobile pour un client, depuis le concept initial jusqu'au déploiement sur les stores.",
    className: "md:col-span-2",
    thumbnail: "/exp3.svg"
  },
  {
