...
export const PinContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative group/pin z-50  cursor-pointer h-[600px]",
        containerClassName
      )}
    ...
    >
      <div
        ...
        className="absolute w-full h-full md:h-[50rem]  left-1/2 top-1/2 ml-[0.09375rem] mt-4 -translate-x-1/2 -translate-y-1/2"
      >
        <div
          style={{
            transform: transform,
